...
namespace AlocaGFT.Migrations
{
    ...
    [Migration("20201111130535_AdicionandoSeeds")]
    partial class AdicionandoSeeds
    {
            ...
            modelBuilder.Entity("AlocaGFT.Models.Cargo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 68, DateTimeKind.Local).AddTicks(7872),
                            level = 0,
                            nome = "Starter",
                            status = true
                        });
            ...
            modelBuilder.Entity("AlocaGFT.Models.Endereco", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            cep = "06454-000",
                            cidade = "Barueri",
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 64, DateTimeKind.Local).AddTicks(8713),
                            latitude = -23.500498f,
                        ...
                        new
                        {
                            ...
                            cep = "18095-450",
                            cidade = "Sorocaba",
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 67, DateTimeKind.Local).AddTicks(7951),
                            latitude = -23.487108f,
            ...
            modelBuilder.Entity("AlocaGFT.Models.Funcionario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1L,
                            cargoid = 1L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 71, DateTimeKind.Local).AddTicks(2778),
                            gftid = 1L,
                            inicio_wa = new DateTime(2020, 11, 11, 10, 5, 35, 71, DateTimeKind.Local).AddTicks(4364),
                            matricula = "N412302",
                            nome = "Lucas Camargo",
                            status = true,
                            termino_wa = new DateTime(2020, 11, 26, 10, 5, 35, 71, DateTimeKind.Local).AddTicks(4768)
                        });
                });
            ...
            modelBuilder.Entity("AlocaGFT.Models.Gft", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 68, DateTimeKind.Local).AddTicks(1925),
                            enderecoid = 1L,
                            nome = "GFT Alphaville",
                            status = true,
                        ...
                        {
                            id = 2L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 68, DateTimeKind.Local).AddTicks(4289),
                            enderecoid = 2L,
                            nome = "GFT Sorocaba",
                            status = true,
                            telefone = "(11)2176-3253"
            ...
            modelBuilder.Entity("AlocaGFT.Models.Tecnologia", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 69, DateTimeKind.Local).AddTicks(3990),
                        ...
                        {
                            id = 2L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 69, DateTimeKind.Local).AddTicks(6091),
                        ...
                        {
                            id = 3L,
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 69, DateTimeKind.Local).AddTicks(6199),
            ...
            modelBuilder.Entity("AlocaGFT.Models.Vaga", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            abertura = new DateTime(2020, 11, 11, 10, 5, 35, 70, DateTimeKind.Local).AddTicks(3596),
                            codigoVaga = "#ITAU-2020-11",
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 70, DateTimeKind.Local).AddTicks(2767),
                        ...
                        {
                            id = 2L,
                            abertura = new DateTime(2021, 11, 11, 10, 5, 35, 70, DateTimeKind.Local).AddTicks(6387),
                            codigoVaga = "#ITAU-2021-11",
                            data_criacao = new DateTime(2020, 11, 11, 10, 5, 35, 70, DateTimeKind.Local).AddTicks(6359),
