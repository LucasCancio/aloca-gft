...
namespace AlocaGFT.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DataType(DataType.Password)]
            [Display(Name = "Confimação da Senha")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    #region Criação de claims personalizadas

                    await _userManager.AddClaimAsync(user, new Claim("Name", Input.Nome));
                    await _userManager.AddClaimAsync(user, new Claim("Level", Input.Level.ToString()));
                    await _userManager.AddClaimAsync(user, new Claim("CPF", Input.CPF));
